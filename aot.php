...
<head>
    ...
    <title>Question Attaque des Titans</title>
</head>
<body>
...
<main>
    ...
    <section>
        <div class="container">
            <h1>Quiz Histoire Shingeki No kyojin</h1>
            <div>
                <img class="image-quizz" src="assets/images/snk.jpg" alt="Quizz Time!">
            </div>
            <div>
...
<script src="assets/js/aot.js"></script>
</body>
</html>